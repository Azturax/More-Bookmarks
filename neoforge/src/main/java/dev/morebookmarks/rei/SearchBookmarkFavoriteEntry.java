...
public final class SearchBookmarkFavoriteEntry extends FavoriteEntry {
	public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("morebookmarks", "search");
	...
	public Renderer getRenderer(boolean showcase) {
		return new Renderer() {
			...
			public void render(GuiGraphics graphics, Rectangle bounds, int mouseX, int mouseY, float delta) {
				...
				graphics.drawString(font, label, bounds.x + 1, bounds.y + Math.max(1, (bounds.height - 8) / 2), 0xFF88AAFF, false);
			}

			@Override
			public Tooltip getTooltip(me.shedaniel.rei.api.client.gui.widgets.TooltipContext context) {
				return Tooltip.create(Component.translatable("morebookmarks.tooltip.apply", query));
			}
		};
	}
	...
	public enum Type implements FavoriteEntryType<SearchBookmarkFavoriteEntry> {
		...
		@Override
		public DataResult<SearchBookmarkFavoriteEntry> read(CompoundTag object) {
		...
		@Override
		public CompoundTag save(SearchBookmarkFavoriteEntry entry, CompoundTag tag) {
